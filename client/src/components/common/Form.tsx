...
propertyImage } : FormProps) => {
  return (
    <Box>
      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#FAF9F6">
        <form style={{ marginTop: '20px', width: "100%", display: "flex", flexDirection: "column", gap: "20px" }} onSubmit={handleSubmit(onFinishHandler)}>
          ...
          <Stack direction="column" gap={1} justifyContent="center" mb={2}>
            <Stack direction="row" gap={2}>
              <Typography color="#11142d" fontSize={16} fontWeight={500} my="10px">Photo:</Typography>
            ...
            <Typography color="#808191" fontSize={14} sx={{wordBreak: 'break-all'}}>{propertyImage?.name}</Typography>
          </Stack>
