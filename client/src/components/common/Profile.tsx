...
const Profile = ({ type, name, avatar, email, properties }: ProfileProps) => (
  <Box>
    ...
    >
      ...
      >
        <img
          src="https://images.unsplash.com/photo-1682370992900-d2ba92e09d7b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1932&q=80"
          width={340}
          height={320}
          alt="abstract"
              ...
              <Stack direction="column" gap="30px">
                <Stack gap="15px">
                  ...
                  <Box display="flex" flexDirection="row" alignItems="center" gap="10px">
                    ...
                    <Typography fontSize={14} color="#11142D">123 Four Road, London, W1 1AA, United Kingdom </Typography>
                  </Box>
                </Stack>
                ...
                <Stack direction="row" flexWrap="wrap" gap="20px" pb={4}>
                  <Stack flex={1} gap="15px">
                    ...
                    <Box display="flex" flexDirection="row" alignItems="center" gap="10px">
                      ...
                      <Typography fontSize={14} color="#11142D" noWrap>+44 161 562 4531</Typography>
                    </Box>
                  </Stack>
